        ...
        <div style={{display:'flex', justifyContent:'center'}}>
          ...
          <form onSubmit={formik.handleSubmit}>
            <div className='register-input-container'>
              ...
              {!formik.errors.password && <button className='visible-btn' onClick={() => handleVisible()} style={{background:'none', height:'27px', border:'none'}}> { visible ? <ImEye className='visible-icon'/> : <ImEyeBlocked className='visible-icon'/>} </button>} 
              ...
              {!formik.errors.confirmPassword && <button className='visible-btn' onClick={() => handleVisible()} style={{background:'none', height:'27px', border:'none'}}> { visible ? <ImEye className='visible-icon'/> : <ImEyeBlocked className='visible-icon'/>} </button>} 
